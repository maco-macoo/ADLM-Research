...
checkpoint_path=YOUR-BASE-PATH/remdm/outputs/checkpoints/sedd.ckpt
T=0
sampling_steps=1024
generated_seqs_path=YOUR-BASE-PATH/remdm/outputs/sedd_T-${sampling_steps}.json
